<template>
    <div style="display: contents;">
        <a href="#" 
            ...
            @click="assign();"
            class="right-float"><i class="i-Add-User text-white mr-2"></i>Edit Colomns
          </a>
       ...
       <b-modal  id="bd-example-modal-lg" size="lg" class="fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"  style="display: none;" aria-hidden="true" >
                            <div slot="modal-header">
                                ...
                                <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span type="button" v-b-modal.customFieldModal aria-hidden="true">Add Custom Field </span> <span  class="btn " type="button" @click="$bvModal.hide('bd-example-modal-lg'); assign();">X</span></button>
