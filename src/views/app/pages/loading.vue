<template>
    <div v-if="is_load" class="loading_main">
...
<div class="div_1_rect"></div>
  ...
  <rect y="5" width="70" height="12.25" rx="6.125" fill="url(#paint0_linear_364_64)"/>
  <defs>
    <linearGradient id="paint0_linear_364_64" x1="70" y1="11.2325" x2="5.40065e-07" y2="11.2325" gradientUnits="userSpaceOnUse">
      <stop stop-color="#DBDBDB" stop-opacity="0.05"/>
      <stop offset="0.5" stop-color="#DBDBDB"/>
    </linearGradient>
  </defs>
